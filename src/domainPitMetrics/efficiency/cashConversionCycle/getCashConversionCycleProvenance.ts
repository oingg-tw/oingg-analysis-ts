...
import { calculatePayablesDays } from '../payablesDays/calculatePayablesDays';
import { calculateCashConversionCycle } from './calculateCashConversionCycle';
  ...
  const entries: ProvenanceEntry[] = [
    ...ttmQuarters.map(
      (tq, i): ProvenanceEntry => ({
        role: `TTM 營業成本（第 ${i + 1}/4 季，用於 DIO/DPO）`,
