...
import { getCashFlowStatementXbrlFirst, type CashFlowFields } from '@/shared/sourceData/cashFlowStatementXbrlFirst';
import { getInsuranceIncomeStatementXbrlFirst, type InsuranceIncomeStatementFields } from '@/shared/sourceData/insuranceIncomeStatementXbrlFirst';
import { getPaidInSharesAsOf, type PaidInSharesAsOf } from '@/shared/sourceData/capitalStock';
import { getStockPriceAsOf, getMarketCapAsOf, type StockPriceAsOf, type MarketCapAsOf } from '@/shared/sourceData/marketCap';
