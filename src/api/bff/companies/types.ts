...
export const companyPeerGroupResultSchema = z.object({
  ...
  source: z.enum(['keyword', 'gemini']).nullable().meta({ description: '目標公司分類的判斷來源——2026-09-15 取代原本的 confidence/sampleSize，keyword 代表僅用免費關鍵字規則判斷、gemini 代表額外經過 Gemini 語意驗證/修正過，全市場 source=keyword 的公司極少（<1%）' }),
