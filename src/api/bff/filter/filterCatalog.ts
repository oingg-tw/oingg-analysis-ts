...
export const filterCatalog: FilterCategory[] = [
  ...
  },
  {
    ...
    name: '韌性',
    metrics: [
      // 底下 3 個顯示分組都來自同一支 API（GET /resilience/liquidity-ratio）、同一個 model
      // （LiquidityRatioResult），modelKey 統一填 'liquidityRatio'——同一種理由，三個是各自
      // 獨立有意義的比率，不該擠在同一個 name 裡。
      {
        key: 'currentRatio',
        name: '流動比率',
        path: '/resilience/liquidity-ratio',
      ...
      },
      {
        ...
        name: '利息保障倍數',
        path: '/resilience/interest-coverage',
      ...
      },
      {
        key: 'netDebtToEbitda',
        name: '淨負債對 EBITDA 比',
        path: '/resilience/net-debt-to-ebitda',
  ...
  },
  {
    ...
    metrics: [
      ...
      },
      {
        ...
        // src/domainMetrics/guru/README.md，公式細節屬於文件該講的事，不放進 name。
