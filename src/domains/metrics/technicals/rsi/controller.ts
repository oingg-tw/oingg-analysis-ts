...
import { z } from 'zod';
import { calculateRsi } from './service';
...
export const getRsi = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const result = await calculateRsi(validationResult.data);
