 ...
 *       （[`src/domains/profitability/roe/service.ts`](../roe/service.ts)）跟 `calculateDividendPayoutRatio`
 *       （[`src/domains/profitability/dividendPayoutRatio/service.ts`](../dividendPayoutRatio/service.ts)），
