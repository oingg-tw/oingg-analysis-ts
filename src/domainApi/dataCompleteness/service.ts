import { indicatorJobs } from '@/domainBatch/indicatorRegistry';
import type { CategoryCompleteness, DataCompletenessQuery, DataCompletenessResult, IndicatorAvailability } from './types';

// 直接呼叫全部 44 支 calculate*（跟批次入口共用同一份
// src/domainBatch/indicatorRegistry.ts 登錄檔），用「這次呼叫有沒有 warnings」判斷這支指標對這家
