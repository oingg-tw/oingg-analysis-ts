...
import { resolveField } from '@/domainApi/filter/metricTableRegistry';
import { buildValuesSql, type FieldRef, type IndexedField } from '@/domainApi/screener/queryBuilder';
import { indicatorJobs, type IndicatorJob } from '@/domainBatch/indicatorRegistry';
...
// domainApi 讀取優先：先讀 analysis 結果表，查不到（asOfDate === null）才委派給 domainBatch
