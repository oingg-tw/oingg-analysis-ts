...
import { calculateNcav } from '@/domainBatch/metrics/guru/ncav/service';
...
export const getNcav = async (req: CompanyRouteRequest, res: CompanyRouteResponse) => {
    ...
    return calculateNcav(validationResult.data);
};
