...
import { calculateKd } from '@/domainBatch/metrics/technicals/kd/service';
...
export const getKd = async (req: CompanyRouteRequest, res: CompanyRouteResponse) => {
    ...
    return calculateKd(validationResult.data);
};
