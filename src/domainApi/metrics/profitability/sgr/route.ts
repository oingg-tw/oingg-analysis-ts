 ...
 *       （[`src/domainApi/metrics/profitability/roe/service.ts`](../roe/service.ts)）跟 `calculateDividendPayoutRatio`
 *       （[`src/domainApi/metrics/profitability/dividendPayoutRatio/service.ts`](../dividendPayoutRatio/service.ts)），
