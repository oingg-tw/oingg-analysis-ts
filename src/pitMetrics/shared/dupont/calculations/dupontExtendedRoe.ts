...
// 的組裝結果，理論上等於 dupontDecomposedRoe。taxBurdenPct/interestBurdenPct/ebitMarginPct
// 三個都已經是 *100 的百分比（不是原始比率），跟 assetTurnover/equityMultiplier 這兩個原始
// 比率相乘後，總共多乘了 100^2，最後除以 10000 校正回正確的百分比尺度——這是這批指標最容易
// 踩的坑，已用 2330 115Q2 真實數字驗證過這個公式算出來的結果精確等於 dupontDecomposedRoe。
