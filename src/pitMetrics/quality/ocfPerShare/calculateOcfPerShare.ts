import { determineNullReason, toPerShare, annualizeQuarterly, type AnnualizableCalcResult } from '@/pitMetrics/numericHelpers';
...
export const calculateOcfPerShare = (operatingCashFlow: bigint | null, shares: bigint | null): AnnualizableCalcResult => {
