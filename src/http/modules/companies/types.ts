...
export const dividendHistoryEventSchema = z.object({
  ...
  cashDividendFromCapitalReserve: z.number().meta({ description: '元／股，現金股利中「資本公積」發放的部分' }),
...
export const dividendHistoryEntrySchema = z.object({
  ...
  cashDividendFromCapitalReserve: z.number().meta({ description: '該年度各次「資本公積」發放加總，元／股' }),
