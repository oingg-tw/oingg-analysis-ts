...
export const financeCostPerShareDefinition: MetricDefinitionSpec = {
  metricCode: 'financeCostPerShare',
  name: '每股財務成本',
  ...
  formulaLatex: '\\mathrm{FinanceCostPerShare} = \\frac{\\mathrm{FinanceCost}}{\\mathrm{Shares}}',
  ...
  dependsOn: ['finance_costs', 'paidInShares'],
