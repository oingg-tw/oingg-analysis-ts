...
export const administrativeExpensePerShareDefinition: MetricDefinitionSpec = {
  metricCode: 'administrativeExpensePerShare',
  name: '每股管理費用',
  nameEn: 'Administrative Expense Per Share',
  unit: '元',
  formulaNote:
    ...
    '加總還原而新增。',
  formulaLatex: '\\mathrm{AdministrativeExpensePerShare} = \\frac{\\mathrm{AdminExpense}}{\\mathrm{Shares}}',
