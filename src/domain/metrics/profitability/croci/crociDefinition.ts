...
export const crociDefinition: MetricDefinitionSpec = {
  ...
  formulaNote:
    ...
    '含本季加總）；Economic Capital = 本季期末總資產－流動負債（簡化版，接近 ROIC 的' +
    '投入資本定義，不做通膨/資本化調整）。TTM = Gross Cash Flow / Economic Capital * 100。',
  formulaLatex: '\\mathrm{CROCI} = \\frac{\\mathrm{NetIncome} + \\mathrm{D\\&A} + \\mathrm{Interest}}{\\mathrm{Assets} - \\mathrm{CurrentLiabilities}} \\times 100',
