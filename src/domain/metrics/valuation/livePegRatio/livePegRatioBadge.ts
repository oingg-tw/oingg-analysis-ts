...
export const livePegRatioBadge: MetricBadge = {
  ...
  detail:
    ...
    '公司跟一家成長率 5% 的公司，對應的評價天差地遠。PEG = 本益比 ÷ 盈餘成長率（%，用' +
    ...
    '大致代表定價與成長率相稱，明顯低於 1 代表相對於成長性而言股價較低，高於 1（尤其遠高於）' +
    '則相對較高，這是一個經驗法則，不是嚴謹的學術估值模型。',
  timeframe: 'EOD',
  threshold: {
    description: '< 1',
    thresholdLatex: '\\mathrm{LivePEG} < 1',
    note: 'Lynch 的經驗法則：PEG ≈ 1 大致代表定價與成長率相稱，明顯低於 1 代表相對成長性而言股價較低',
    denominator: 1,
    comparator: 'lt',
    value: 1,
  },
