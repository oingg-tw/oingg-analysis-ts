...
export const PROVENANCE_RESOLVERS: Record<(typeof PILOT_PROVENANCE_METRIC_CODES)[number], (query: QuarterlyMetricQuery) => Promise<MetricProvenanceResult>> = {
  ...
  chowderNumber: (query) => getChowderNumberProvenance(query, legacyPitDeps),
  sue: (query) => getSueProvenance(query, legacyPitDeps),
  accrualsRatio: (query) => getAccrualsRatioProvenance(query, legacyPitDeps),
  dividendPayoutRatio: (query) => getDividendPayoutRatioProvenance(query, legacyPitDeps),
  altmanZScore: (query) => getAltmanZScoreProvenance(query, legacyPitDeps),
  dupontTaxBurden: (query) => getDupontTaxBurdenProvenance(query, legacyPitDeps),
  dupontInterestBurden: (query) => getDupontInterestBurdenProvenance(query, legacyPitDeps),
  inventoryTurnover: (query) => getInventoryTurnoverProvenance(query, legacyPitDeps),
  receivablesTurnover: (query) => getReceivablesTurnoverProvenance(query, legacyPitDeps),
  fixedAssetTurnover: (query) => getFixedAssetTurnoverProvenance(query, legacyPitDeps),
  payablesTurnover: (query) => getPayablesTurnoverProvenance(query, legacyPitDeps),
  inventoryDays: (query) => getInventoryDaysProvenance(query, legacyPitDeps),
  receivablesDays: (query) => getReceivablesDaysProvenance(query, legacyPitDeps),
  payablesDays: (query) => getPayablesDaysProvenance(query, legacyPitDeps),
  cashConversionCycle: (query) => getCashConversionCycleProvenance(query, legacyPitDeps),
  operatingCycle: (query) => getOperatingCycleProvenance(query, legacyPitDeps),
  netWorkingCapitalTurnover: (query) => getNetWorkingCapitalTurnoverProvenance(query, legacyPitDeps),
  inventoryToRevenueRatio: (query) => getInventoryToRevenueRatioProvenance(query, legacyPitDeps),
  receivablesToRevenueRatio: (query) => getReceivablesToRevenueRatioProvenance(query, legacyPitDeps),
  capexToRevenue: (query) => getCapexToRevenueProvenance(query, legacyPitDeps),
  capexToOcfRatio: (query) => getCapexToOcfRatioProvenance(query, legacyPitDeps),
  operatingExpenseRatio: (query) => getOperatingExpenseRatioProvenance(query, legacyPitDeps),
  currentRatio: (query) => getCurrentRatioProvenance(query, legacyPitDeps),
  quickRatio: (query) => getQuickRatioProvenance(query, legacyPitDeps),
  cashRatio: (query) => getCashRatioProvenance(query, legacyPitDeps),
  debtRatio: (query) => getDebtRatioProvenance(query, legacyPitDeps),
  deRatio: (query) => getDeRatioProvenance(query, legacyPitDeps),
  longTermDebtToNetCurrentAssets: (query) => getLongTermDebtToNetCurrentAssetsProvenance(query, legacyPitDeps),
  equityRatio: (query) => getEquityRatioProvenance(query, legacyPitDeps),
  cashToAssetsRatio: (query) => getCashToAssetsRatioProvenance(query, legacyPitDeps),
  financialLeverageDegree: (query) => getFinancialLeverageDegreeProvenance(query, legacyPitDeps),
  totalLeverageDegree: (query) => getTotalLeverageDegreeProvenance(query, legacyPitDeps),
  interestCoverage: (query) => getInterestCoverageProvenance(query, legacyPitDeps),
  netDebtToEbitda: (query) => getNetDebtToEbitdaProvenance(query, legacyPitDeps),
  netWorkingCapitalToAssets: (query) => getNetWorkingCapitalToAssetsProvenance(query, legacyPitDeps),
  totalDebtToCapital: (query) => getTotalDebtToCapitalProvenance(query, legacyPitDeps),
  debtToFcf: (query) => getDebtToFcfProvenance(query, legacyPitDeps),
  altmanZDoublePrimeScore: (query) => getAltmanZDoublePrimeScoreProvenance(query, legacyPitDeps),
  zmijewskiScore: (query) => getZmijewskiScoreProvenance(query, legacyPitDeps),
  ohlsonOScore: (query) => getOhlsonOScoreProvenance(query, legacyPitDeps),
  eps: (query) => getEpsProvenance(query, legacyPitDeps),
  pretaxIncomePerShare: (query) => getPretaxIncomePerShareProvenance(query, legacyPitDeps),
  revenuePerShare: (query) => getRevenuePerShareProvenance(query, legacyPitDeps),
  roa: (query) => getRoaProvenance(query, legacyPitDeps),
  netProfitMargin: (query) => getNetProfitMarginProvenance(query, legacyPitDeps),
  dupontEbitMargin: (query) => getDupontEbitMarginProvenance(query, legacyPitDeps),
  novyMarxGpToAssets: (query) => getNovyMarxGpToAssetsProvenance(query, legacyPitDeps),
  nonOperatingIncomeRatio: (query) => getNonOperatingIncomeRatioProvenance(query, legacyPitDeps),
  croci: (query) => getCrociProvenance(query, legacyPitDeps),
  croic: (query) => getCroicProvenance(query, legacyPitDeps),
  roic: (query) => getRoicProvenance(query, legacyPitDeps),
  roce: (query) => getRoceProvenance(query, legacyPitDeps),
  greenblattRoc: (query) => getGreenblattRocProvenance(query, legacyPitDeps),
  nissimPenmanRnoa: (query) => getNissimPenmanRnoaProvenance(query, legacyPitDeps),
  famaFrenchOperatingProfitability: (query) => getFamaFrenchOperatingProfitabilityProvenance(query, legacyPitDeps),
  consecutiveProfitYears: (query) => getConsecutiveProfitYearsProvenance(query, legacyPitDeps),
  grossMargin: (query) => getGrossMarginProvenance(query, legacyPitDeps),
  operatingMargin: (query) => getOperatingMarginProvenance(query, legacyPitDeps),
  assetGrowth: (query) => getAssetGrowthProvenance(query, legacyPitDeps),
  revenueGrowthRate: (query) => getRevenueGrowthRateProvenance(query, legacyPitDeps),
  netIncomeGrowthRate: (query) => getNetIncomeGrowthRateProvenance(query, legacyPitDeps),
  operatingIncomeGrowthRate: (query) => getOperatingIncomeGrowthRateProvenance(query, legacyPitDeps),
  equityGrowthRate: (query) => getEquityGrowthRateProvenance(query, legacyPitDeps),
  bvpsGrowthRate: (query) => getBvpsGrowthRateProvenance(query, legacyPitDeps),
  epsGrowthRate: (query) => getEpsGrowthRateProvenance(query, legacyPitDeps),
  rdIntensity: (query) => getRdIntensityProvenance(query, legacyPitDeps),
  sgr: (query) => getSgrProvenance(query, legacyPitDeps),
  epsCagr3y: getEpsCagrProvenanceForYears(3, legacyPitDeps),
  epsCagr5y: getEpsCagrProvenanceForYears(5, legacyPitDeps),
  epsCagr8y: getEpsCagrProvenanceForYears(8, legacyPitDeps),
  revenueCagr3y: getRevenueCagrProvenanceForYears(3, legacyPitDeps),
  revenueCagr5y: getRevenueCagrProvenanceForYears(5, legacyPitDeps),
  revenueCagr8y: getRevenueCagrProvenanceForYears(8, legacyPitDeps),
  buybackYield: (query) => getBuybackYieldProvenance(query, legacyPitDeps),
  consecutiveDividendYears: (query) => getConsecutiveDividendYearsProvenance(query, legacyPitDeps),
  dividendCoverageRatio: (query) => getDividendCoverageRatioProvenance(query, legacyPitDeps),
  dividendGrowthRate3y: getDividendGrowthRateProvenanceForYears(3, legacyPitDeps),
  dividendGrowthRate5y: getDividendGrowthRateProvenanceForYears(5, legacyPitDeps),
  dividendGrowthRate8y: getDividendGrowthRateProvenanceForYears(8, legacyPitDeps),
  shareCountChangeRate: (query) => getShareCountChangeRateProvenance(query, legacyPitDeps),
  stockPrice: (query) => getStockPriceProvenance(query, legacyPitDeps),
  marketCap: (query) => getMarketCapProvenance(query, legacyPitDeps),
  bvps: (query) => getBvpsProvenance(query, legacyPitDeps),
  pbRatio: (query) => getPbRatioProvenance(query, legacyPitDeps),
  peRatio: (query) => getPeRatioProvenance(query, legacyPitDeps),
  psr: (query) => getPsrProvenance(query, legacyPitDeps),
  pFcf: (query) => getPFcfProvenance(query, legacyPitDeps),
  fcfYield: (query) => getFcfYieldProvenance(query, legacyPitDeps),
  ncav: (query) => getNcavProvenance(query, legacyPitDeps),
  evEbitda: (query) => getEvEbitdaProvenance(query, legacyPitDeps),
  evToEbit: (query) => getEvToEbitProvenance(query, legacyPitDeps),
  evToFcf: (query) => getEvToFcfProvenance(query, legacyPitDeps),
  evToOcf: (query) => getEvToOcfProvenance(query, legacyPitDeps),
  evToSales: (query) => getEvToSalesProvenance(query, legacyPitDeps),
  priceToOcf: (query) => getPriceToOcfProvenance(query, legacyPitDeps),
  grahamNumber: (query) => getGrahamNumberProvenance(query, legacyPitDeps),
  earningsYield: (query) => getEarningsYieldProvenance(query, legacyPitDeps),
  tobinsQ: (query) => getTobinsQProvenance(query, legacyPitDeps),
  pegRatio: (query) => getPegRatioProvenance(query, legacyPitDeps),
  abnormalCapexRatio: (query) => getAbnormalCapexRatioProvenance(query, legacyPitDeps),
  beneishAqi: (query) => getBeneishAqiProvenance(query, legacyPitDeps),
  beneishDsri: (query) => getBeneishDsriProvenance(query, legacyPitDeps),
  beneishMScore: (query) => getBeneishMScoreProvenance(query, legacyPitDeps),
  fcfConversionRate: (query) => getFcfConversionRateProvenance(query, legacyPitDeps),
  fcfMargin: (query) => getFcfMarginProvenance(query, legacyPitDeps),
  fcfPerShare: (query) => getFcfPerShareProvenance(query, legacyPitDeps),
  ocfMargin: (query) => getOcfMarginProvenance(query, legacyPitDeps),
  ocfPerShare: (query) => getOcfPerShareProvenance(query, legacyPitDeps),
  depreciationAmortizationPerShare: (query) => getDepreciationAmortizationPerShareProvenance(query, legacyPitDeps),
  ocfToNetIncome: (query) => getOcfToNetIncomeProvenance(query, legacyPitDeps),
  ownerEarnings: (query) => getOwnerEarningsProvenance(query, legacyPitDeps),
};
