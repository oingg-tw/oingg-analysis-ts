...
import { financialDataAdapter, type IncomeStatementPort, type CashFlowStatementPort, type MarketCapPort } from '@/application/metrics/shared/ports/financialDataPorts';
