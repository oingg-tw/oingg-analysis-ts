...
export const computeConsecutiveDividendYears = async (query: QuarterlyMetricQuery, deps: ConsecutiveDividendYearsDeps): Promise<ConsecutiveDividendYearsComputationBatch> => {
