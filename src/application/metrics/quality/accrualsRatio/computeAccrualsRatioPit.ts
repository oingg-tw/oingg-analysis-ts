...
import type { CashFlowFields } from '@/infrastructure/repositories/mops/cashFlowStatementXbrlFirst';
import { financialDataAdapter, type BalanceSheetPort, type IncomeStatementPort, type CashFlowStatementPort } from '@/application/metrics/shared/ports/financialDataPorts';
