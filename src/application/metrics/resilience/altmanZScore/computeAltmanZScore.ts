...
export const resolveAltmanZScoreInputs = async (query: QuarterlyMetricQuery, deps: AltmanZScoreDeps): Promise<AltmanZScoreResolution | null> => {
...
export const computeAltmanZScore = async (query: QuarterlyMetricQuery, deps: AltmanZScoreDeps): Promise<AltmanZScoreComputationBatch> => {
