...
export type CashToAssetsRatioDeps = Pick<PitDeps, 'statements' | 'quarters' | 'announcements'>;

export type CashToAssetsRatioComputationBatch = ComputationBatch<'q'>;

export const computeCashToAssetsRatio = async (query: QuarterlyMetricQuery, deps: CashToAssetsRatioDeps): Promise<CashToAssetsRatioComputationBatch> => {
