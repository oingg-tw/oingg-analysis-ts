...
export type LongTermDebtToNetCurrentAssetsDeps = Pick<PitDeps, 'statements' | 'quarters' | 'announcements'>;

export type LongTermDebtToNetCurrentAssetsComputationBatch = ComputationBatch<'q'>;

export const computeLongTermDebtToNetCurrentAssets = async (
  query: QuarterlyMetricQuery,
  deps: LongTermDebtToNetCurrentAssetsDeps
): Promise<LongTermDebtToNetCurrentAssetsComputationBatch> => {
