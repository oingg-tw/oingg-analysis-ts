...
export type TobinsQDeps = Pick<PitDeps, 'statements' | 'quarters' | 'announcements' | 'market'>;

export type TobinsQComputationBatch = ComputationBatch<'q'>;

export const computeTobinsQ = async (
  query: QuarterlyMetricQuery,
  deps: TobinsQDeps
): Promise<TobinsQComputationBatch> => {
