...
import { financialDataAdapter, type BalanceSheetPort, type IncomeStatementPort, type PaidInSharesPort, type StockPricePort } from '@/application/metrics/shared/ports/financialDataPorts';
