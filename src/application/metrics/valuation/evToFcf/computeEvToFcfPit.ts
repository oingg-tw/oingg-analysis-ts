...
import { financialDataAdapter, type BalanceSheetPort, type CashFlowStatementPort, type MarketCapPort } from '@/application/metrics/shared/ports/financialDataPorts';
