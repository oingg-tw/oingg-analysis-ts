...
export type StockPriceDeps = Pick<PitDeps, 'statements' | 'quarters' | 'announcements' | 'market'>;

export type StockPriceComputationBatch = ComputationBatch<'q'>;

export const computeStockPrice = async (
  query: QuarterlyMetricQuery,
  deps: StockPriceDeps
): Promise<StockPriceComputationBatch> => {
