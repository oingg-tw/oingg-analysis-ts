...
export const GENERAL_METRIC_CODES = [
  ...
  'grahamNumber', 'ownerEarnings', 'altmanZScore', 'piotroskiFScore', 'oneilCanslimScore', 'beneishMScore', 'nissimPenmanRnoa', 'zmijewskiScore', 'ohlsonOScore',
...
export const buildGeneralTasks = (symbol: string, quarter?: { year: string; season: '1' | '2' | '3' | '4' }): BackfillTask[] => {
  ...
  const periodTasks: BackfillTask[] = [
    ...
    ['oneilCanslimScore', () => computeAndWriteOneilCanslimScorePit(query)],
